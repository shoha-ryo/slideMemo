      ...
      <div className="mx-auto max-w-3xl">
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">最終更新日: 2026年1月4日</p>
          </CardHeader>
          <CardContent className="space-y-6 text-sm leading-relaxed">
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">1. 基本方針</h2>
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">2. 個人情報の定義</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">3. 収集する情報</h2>
              <div className="space-y-3 text-muted-foreground">
                <p>当社は、本サービスの提供にあたり、以下の情報を収集します:</p>
                <div className="space-y-3">
                  <div>
                    <h3 className="mb-2 font-semibold text-foreground">3.1 ユーザーが提供する情報</h3>
                  ...
                  <div>
                    <h3 className="mb-2 font-semibold text-foreground">3.2 自動的に収集される情報</h3>
                    <ul className="list-disc space-y-1 pl-6">
                      <li>IPアドレス</li>
                      <li>ブラウザの種類とバージョン</li>
                      <li>デバイス情報</li>
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">4. 利用目的</h2>
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">5. 第三者への提供</h2>
              <div className="space-y-2 text-muted-foreground">
                <p>当社は、以下の場合を除き、ユーザーの同意なく第三者に個人情報を提供しません:</p>
                <ul className="list-disc space-y-1 pl-6">
                  <li>法令に基づく場合</li>
                  <li>人の生命、身体または財産の保護のために必要がある場合</li>
                  <li>公衆衛生の向上または児童の健全な育成の推進のために必要がある場合</li>
                  <li>国の機関等の法令の定める事務への協力で、ユーザーの同意を得ることが困難な場合</li>
                </ul>
              </div>
            </section>

            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">6. 安全管理措置</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">7. Cookieの使用</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">8. ユーザーの権利</h2>
              <div className="space-y-2 text-muted-foreground">
                <p>ユーザーは、当社が保有する自己の個人情報について、以下の権利を有します:</p>
                <ul className="list-disc space-y-1 pl-6">
                  <li>開示を求める権利</li>
                ...
                <p className="mt-2">これらの権利行使については、support@taskflow.comまでお問い合わせください。</p>
              </div>
            </section>

            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">9. 本ポリシーの変更</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">10. お問い合わせ</h2>
              <p className="text-muted-foreground">
