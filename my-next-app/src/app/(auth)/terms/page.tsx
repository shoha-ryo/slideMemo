      ...
      <div className="mx-auto max-w-3xl">
        ...
        <Card>
          ...
          <CardContent className="space-y-6 text-sm leading-relaxed">
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">1. はじめに</h2>
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">2. アカウント登録</h2>
              <div className="space-y-2 text-muted-foreground">
                <p>本サービスの利用には、アカウント登録が必要です。登録時には、正確で最新の情報を提供してください。</p>
                <ul className="list-disc space-y-1 pl-6">
                  <li>18歳以上の方のみ登録が可能です</li>
                  <li>1人につき1つのアカウントのみ登録できます</li>
                  <li>アカウント情報の管理責任はユーザーにあります</li>
                  <li>不正なアカウント使用が発覚した場合、アカウントを停止する場合があります</li>
                </ul>
              </div>
            </section>

            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">3. 禁止事項</h2>
              <div className="space-y-2 text-muted-foreground">
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">4. 知的財産権</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">5. サービスの変更・終了</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">6. 免責事項</h2>
              <div className="space-y-2 text-muted-foreground">
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">7. 規約の変更</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="mb-3 text-xl font-semibold text-foreground">8. お問い合わせ</h2>
              <p className="text-muted-foreground">
