    ...
    await prisma.$transaction(
      async (tx) => {
        ...
        if (deleteTasks.cardIds.length > 0) {
          ...
          deleteTasks.cardIds.forEach((id) =>
            activityLogsToCreate.push({
              projectId,
              entityId: id,
              entityType: "CARD",
        ...
        if (deleteTasks.boardIds.length > 0) {
          ...
          deleteTasks.boardIds.forEach((id) =>
            activityLogsToCreate.push({
              projectId,
              entityId: id,
              entityType: "BOARD",
        ...
        if (deleteTasks.labelIds.length > 0) {
          ...
          deleteTasks.labelIds.forEach((id) =>
            activityLogsToCreate.push({
              projectId,
              entityId: id,
              entityType: "LABEL",
